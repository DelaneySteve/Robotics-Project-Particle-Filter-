function measurement = exampleHelperCarBotGetGPSReading(carbot, CEP,trueVelocity,update_rate)
...
%   Copyright 2015 The MathWorks, Inc.
    ...
    pose = carbot.Pose;
    sd = CEP; 
    measurement = pose(1:3) + sd*randn(3,1); %mesurement plus covariance (standard deviation * 3 random numbers between 0-1)
